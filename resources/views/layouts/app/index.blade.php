            ...
            <ul class="navbar-nav navbar-nav-right ml-auto">
                ...
                <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                        ...
                        <a class="dropdown-item" href="/logoutt"><i class="dropdown-item-icon icon-power text-primary"></i>Sign Out</a>
                        <a class="dropdown-item" href="{{ route('organisation-data') }}"><i class="dropdown-item-icon icon-power text-primary"></i>My Data</a>
                    </div>
                </li>
